package toni.embeddiumextras.foundation.fps;

import toni.embeddiumextras.EmbeddiumExtras;
...
public class DebugOverlayEvent {
    ...
    private static final Component MSG_FPS = Component.translatable("embeddium.extras.options.displayfps.fps");
    private static final Component MSG_MIN = Component.translatable("embeddium.extras.options.displayfps.min");
    private static final Component MSG_AVG = Component.translatable("embeddium.extras.options.displayfps.avg");
    private static final Component MSG_GPU = Component.translatable("embeddium.extras.options.displayfps.gpu");
    private static final Component MSG_MEM = Component.translatable("embeddium.extras.options.displayfps.mem");
