...
public class EntityCullingPage extends OptionPage {
    ...
    public EntityCullingPage() {
        super(Component.translatable("embeddium.extras.options.culling.page"), create());
    }
    ...
    private static ImmutableList<OptionGroup> create() {
        ...
        var enableDistanceChecks = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.culling.entity.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.culling.entity.desc"))
        ...
        var maxEntityDistance = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.culling.entity.distance.horizontal.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.culling.entity.distance.horizontal.desc"))
        ...
        var maxEntityDistanceVertical = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.culling.entity.distance.vertical.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.culling.entity.distance.vertical.desc"))
        ...
        var enableTileDistanceChecks = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.culling.tiles.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.culling.tiles.desc"))
                .setControl(TickBoxControl::new)
                .setBinding(
                        (options, value) -> {
        ...
        var maxTileEntityDistance = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.culling.tile.distance.horizontal.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.culling.tile.distance.horizontal.desc"))
        ...
        var maxTileEntityDistanceVertical = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.culling.tile.distance.vertical.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.culling.tile.distance.vertical.desc"))
                .setControl((option) -> new SliderControl(option, 16, 64, 4, ControlValueFormatter.biomeBlend()))
                .setBinding((options, value) -> {
