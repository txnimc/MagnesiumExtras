...
public class TrueDarknessPage extends OptionPage {
    ...
    public TrueDarknessPage() {
        super(Component.translatable("embeddium.extras.options.darkness.page"), create());
    }
    ...
    private static ImmutableList<OptionGroup> create() {
        ...
        final var darknessMode = OptionImpl.createBuilder(EmbyConfig.DarknessMode.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.mode.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.mode.desc"))
                .setControl((option) -> new CyclingControl<>(option, EmbyConfig.DarknessMode.class, new Component[]{
                        Component.translatable("embeddium.extras.options.darkness.mode.pitchblack"),
                        Component.translatable("embeddium.extras.options.darkness.mode.reallydark"),
                        Component.translatable("embeddium.extras.options.darkness.mode.dark"),
                        Component.translatable("embeddium.extras.options.darkness.mode.dim"),
        ...
        var noSkylight = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.noskylight.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.noskylight.desc"))
        ...
        var darknessOtherDim = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.others.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.others.desc"))
                .setControl(TickBoxControl::new)
                .setBinding((options, value) -> {
        ...
        var darknessOnOverworld = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.overworld.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.overworld.desc"))
                .setControl(TickBoxControl::new)
                .setBinding((options, value) -> {
        ...
        var darknessOnNether = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.nether.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.nether.desc"))
                .setControl(TickBoxControl::new)
                .setBinding((options, value) -> {
        ...
        final var netherFogBright = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.nether.brightness.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.nether.brightness.desc"))
        ...
        var darknessOnEnd = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.end.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.end.desc"))
                .setControl(TickBoxControl::new)
                .setBinding((options, value) -> {
        ...
        final var endFogBright = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.end.brightness.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.end.brightness.desc"))
                .setControl((option) -> new SliderControl(option, 0, 100, 1, ControlValueFormatter.percentage()))
                .setBinding((options, current) -> {
                            var value = current / 100d;
        ...
        var blockLightOnly = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.blocklightonly.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.blocklightonly.desc"))
                .setControl(TickBoxControl::new)
                .setBinding((options, value) -> {
        ...
        var affectedByMoonPhase = OptionImpl.createBuilder(boolean.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.moonphase.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.moonphase.desc"))
                .setControl(TickBoxControl::new)
                .setBinding((options, value) -> {
        ...
        final var newMoonBright = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.moonphase.fresh.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.moonphase.fresh.desc"))
                .setControl((option) -> new SliderControl(option, 0, 100, 1, ControlValueFormatter.percentage()))
                .setBinding((options, current) -> {
                            var value = current / 100d;
        ...
        final var fullMoonBright = OptionImpl.createBuilder(int.class, performanceOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.darkness.moonphase.full.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.darkness.moonphase.full.desc"))
                .setControl((option) -> new SliderControl(option, 0, 100, 1, ControlValueFormatter.percentage()))
                .setBinding((options, current) -> {
                            var value = current / 100d;
