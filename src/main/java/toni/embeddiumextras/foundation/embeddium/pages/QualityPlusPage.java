...
public class QualityPlusPage extends OptionPage {
    ...
    private static ImmutableList<OptionGroup> create() {
        ...
        final var fog = OptionImpl.createBuilder(boolean.class, qualityOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.fog.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.fog.desc"))
        ...
        final var fadeInQuality = OptionImpl.createBuilder(EmbyConfig.ChunkFadeSpeed.class, qualityOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.fadein.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.fadein.desc"))
        ...
        final var cloudHeight = OptionImpl.createBuilder(int.class, qualityOptionsStorage)
                .setName(Component.translatable("embeddium.extras.options.clouds.height.title"))
                .setTooltip(Component.translatable("embeddium.extras.options.clouds.height.desc"))
