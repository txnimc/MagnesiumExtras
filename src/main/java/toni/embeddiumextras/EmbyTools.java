...
public class EmbyTools {
    ...
    public static void setValueInField(Class<?> clazz, String fieldName, Object from, Object value) {
        try {
            ...
            EmbeddiumExtras.LOGGER.error("Cannot set value of '{}' from {}", fieldName, clazz.getName(), e);
        }
    }
    ...
    public static void invokeMethod(Class<?> clazz, String methodName, Object from, Object... values) {
        try {
            ...
            EmbeddiumExtras.LOGGER.error("Cannot invoke method '{}' from {}", methodName, clazz.getName(), e);
        }
    }
    ...
    public static void benchEnd() {
        ...
        EmbeddiumExtras.LOGGER.debug("Current method takes RIGHT NOW {} nanoseconds", BENCHTIMES[BENCH_POS].rightLong() - BENCHTIMES[BENCH_POS].leftLong());
        ...
        if (BENCH_POS == BENCHTIMES.length - 1) {
            ...
            EmbeddiumExtras.LOGGER.info("Current method takes AVG {} nanoseconds", (totalEnd - totalStart) / BENCHTIMES.length);
